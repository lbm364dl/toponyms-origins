...
| Madrid official Callejero historical-vial CSVs | Already applied to Madrid-municipality probable-entry batches: Ibiza, Valdeacederas, Oporto, San Cipriano, Almendrales, Tres Olivos, Acacias, Puerta del Ángel, Lucero, Laguna, Duque de Pastrana, Bambú, Vinateros, Avenida de América, Valdezarza, Opañel, La Elipa, Ascao, Urgel, Abrantes, Buenos Aires, Sierra de Guadalupe, Congosto, Alsacia, Las Suertes, Fuente de la Mora, Orcasitas, El Goloso, Santa Eugenia, Valdebebas, Vallecas, Embajadores, Lavapiés, Chamberí, Moncloa, Canillejas, Valdebernardo, Vicálvaro, Montecarmelo, Hortaleza, Manoteras, Peñagrande, Cuatro Vientos, Aviación Española, Begoña, Fuencarral, Carabanchel Alto, Pan Bendito, Valdecarros, Villaverde Alto, Palas de Rey, Carabanchel, Chamartín, Ventilla, Parque de las Avenidas, and Villa de Vallecas. | Use remaining passes for harder Madrid cases only: ambiguous common names, district-filtered rows, or entries where a specific street-name file is needed. Treat `01/01` dates as possible placeholders unless corroborated, and skip out-of-city station names when the Madrid row is merely a street named after another municipality. |
...
| 2 | Madrid Callejero historical-vial CSVs and municipal naming files | CSV passes are now applied to 56 probable station entries. Continue only for remaining Madrid-municipality cases where district/barrio filtering can disambiguate the row, then use municipal naming files when the CSV date is a placeholder or the motive still needs explanation. |
