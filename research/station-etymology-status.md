...
|---|---:|---:|---:|---:|
| `verified` | 154 | 37 | 30 | 221 |
| `probable` | 88 | 38 | 18 | 144 |
| `uncertain` | 1 | 2 | 0 | 3 |
| `unknown` | 0 | 0 | 0 | 0 |
| **Total** | **243** | **77** | **48** | **368** |

## Current Uncertain Entries

| Station | ID | Next source work |
|---|---|---|
| Coslada | `cercanias_036` | Menéndez Pidal, *Toponimia prerrománica hispana*; García López et al., *Coslada*; García Sánchez, *Atlas toponímico de España*. |
| Aravaca | `cercanias_061` | Start with the free Caridad Arias article already used by related entries; then Gea Ortigas for the "Ara Val Cea" proposal; Nieto Ballester if it has a relevant entry; a critical/facsimile Fuero de Madrid source for medieval forms. |
| Pitis | `metro_167` | Alonso Fernández-Checa for the Metro-facing explanation; Aparisi Laporta and Fuencarral-El Pardo material; Fuencarral cadastral/notarial/municipal records if books do not resolve it. |
